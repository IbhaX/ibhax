...
tags_metadata = [
    ...
    {
        "name": "Knowledge",
        "description": "All world Knowledges"
    }
]
...
@app.get("/philosophers", tags=["Knowledge"], description="Know your philosophers")
def philosophers():
    url  = "https://raw.githubusercontent.com/IbhaX/json/main/philosophers.json"
    response = make_request(url)
    return response
